...
<div class="login_index">
    <div class="login">
        ...
        <div class="login_title">欢迎登陆云购后台管理系统  </div>
        <div class="login_form">
        <ul>
        <form action="#" method="post" id="form">
        <li><span>管理账号:</span><input type="text" id="input-u" name="username" style="color:#f17564;" class="textinput" value="用户名" /></li>
        <li><span>管理密码:</span><input type="password" id="input-p" name="password" style="color:#8ccfb3;" class="textinput"   /></li>
		<?php if(_cfg("web_off")){ ?>
        <li><span>验证码:</span><input type="text" id="input-c" name="code" style="color:#9dcc5a;width:60px;text-transform:uppercase;" class="textinput"  />
