...
<table width="100%" class="lr10">
    ...
    <tr>
			...
			<td>
				<input name="xitong" value="1" checked="checked" type="radio">开
				<input name="xitong" value="0" type="radio">关
			</td>
	    ...
	    <tr>
			...
			<td>
				<input name="neirong" value="1" checked="checked" type="radio">开
				<input name="neirong" value="0" type="radio">关
			</td>
	    ...
	    <tr>
			...
			<td>
				<input name="shop" value="1" checked="checked" type="radio">开
				<input name="shop" value="0" type="radio">关
			</td>
	    ...
	    <tr>
			...
			<td>
				<input name="user" value="1" checked="checked" type="radio">开
				<input name="user" value="0" type="radio">关
			</td>
	    ...
	    <tr>
			...
			<td>
				<input name="jiemian" value="1" checked="checked" type="radio">开
				<input name="jiemian" value="0" type="radio">关
			</td>
	    ...
	    <tr>
			...
			<td>
				<input name="yun" value="1" checked="checked" type="radio">开
				<input name="yun" value="0" type="radio">关
			</td>
