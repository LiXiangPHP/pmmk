...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
		 ...
		 <tr>
			...
			<td><textarea name="description" class="wid400" onKeyUp="gbcount(this,300,'textdescription');" style="height:60px"></textarea><br> <span>还能输入<b id="textdescription">300</b>个字符</span>
            </td>
            <td align="right">回复详情：</td>
			<td><textarea name="detail" class="wid400" onKeyUp="gbcount(this,300,'textdescription');" style="height:60px"></textarea><br> <span>还能输入<b id="textdescription">300</b>个字符</span>
            </td>
		</tr>
               
        <tr height="60px">
			<td align="right"></td>
			<td><input type="submit" name="dosubmit" class="button" value="提交" /></td>
		</tr>
	</table>
</form>
</div>
