...
<div class="R-content">
	...
	<div class="tel_verification">
		<div class="prompt orange">请完成手机验证，验证手机不仅能加强账户安全，快速找回密码，还会在您成功<?php echo _cfg('web_name_two'); ?>到商品后及时通知您！<em></em></div>
		<form method="post" action="<?php echo WEB_PATH; ?>/member/home/mobilesuccess">
		<div class="text_tel" id="divSend" style="display: block;">
			<span>第一步输入手机号码：</span>
			<input  datatype="m" ajaxurl="<?php echo WEB_PATH; ?>/member/home/mailchackajax" nullmsg="不能为空" errormsg="您输入的手机号码有误" name="mobile" type="text" class="tel" maxlength="11">
			<input type="submit" name="submit" class="orangebut" value="确认手机号码">
