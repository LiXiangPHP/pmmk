...
HTML;
	...
	public function goods_add(){		
		...
		if(isset($_POST['dosubmit'])){		
			...
			$goods_key_renqi = isset($_POST['goods_key']['renqi']) ? 1 : 0;
			$goods_key_bannershop = isset($_POST['goods_key']['bannershop']) ? 1 : 0;
			$goods_key_shiyuan = isset($_POST['goods_key']['shiyuan']) ? 1 : 0;
			$goods_key_baiyuan = isset($_POST['goods_key']['baiyuan']) ? 1 : 0;
			...
			$query_1 = $this->db->Query("INSERT INTO `@#_shoplist` (`zhiding`,`cateid`, `brandid`, `title`, `title_style`, `title2`, `keywords`, `description`, `money`, `yunjiage`, `zongrenshu`, `canyurenshu`,`shenyurenshu`, `qishu`,`maxqishu`,`thumb`, `picarr`, `content`,`xsjx_time`,`renqi`,`pos`,`bannershop`,`renqipos`,`newpos`,`posthumb`, `time`, `shiyuan`, `baiyuan`) VALUES ('".htmlspecialchars($_POST['zhiding'])."','$cateid', '$brandid', '$title', '$title_style', '$title2', '$keywords', '$description', '$money', '$yunjiage', '$zongrenshu', '$canyurenshu','$shenyurenshu', '1','$maxqishu', '$thumb', '$picarr', '$content','$xsjx_time','$goods_key_renqi', '$goods_key_pos','$goods_key_bannershop','$renqipos','$newpos','$posthumb','$time', '$goods_key_shiyuan', '$goods_key_baiyuan')");			
