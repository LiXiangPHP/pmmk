...
class index1 extends SystemAction {
	...
	public function glist(){
		...
		//商品列表
		$hotshop = $db->GetList("select id,thumb,title,money,qishu,canyurenshu,shenyurenshu from `@#_shoplist`   where `q_uid` is null and `renqi` = '1' and `shenyurenshu`>0 order by id DESC LIMIT 6 ");
