...
<!-- 内页顶部 -->
 ...
 -->
         <div class="edit-wrapper">
            <input name="txtUserName" id="txtUserName" class="inp-info" maxlength="20" value="<?php echo $member['username']; ?>" type="text">
            <input name="hidSex" id="hidName" type="hidden" value="<?php echo $member['username']; ?>">
            <input name="hidSex" id="uid" type="hidden" value="<?php echo $member['uid']; ?>">
            <p class="txt">昵称长度为2-20个字符，有汉字、字母、数字或"_-"组成</p>
            <a id="btnT1" href="javascript:;" class="s-btn" onclick="editusername()">保存</a>
        </div>
...
function editusername()
{
    ...
    {
        var aj = $.ajax( {  
         url:'<?php echo WEB_PATH; ?>/mobile/ajax/editusername/',// 跳转到 action  
          data:{  
                   username : username,
                   hidName : hidName,
                   uid : uid,
