...
<!--     <section class="g-main">
	    <div class="m-tt1">
		    ...
		    <div class="fr u-more">
			    <a href="<?php echo WEB_PATH; ?>/mobile/autolottery/next" class="u-rs-m2"><b class="z-arrow"></b></a>
		    </div>
	    </div>
    ...
    <section class="g-main">
	    <div class="m-tt1">
		    <h2 class="fl"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist">十元区</a></h2>
		    <div class="fr u-more">
	    ...
	    <article class="clearfix h5-1yyg-w310 m-round m-tj-li">
		    <ul id="ulRecommend">
		        <?php $ln=1;if(is_array($shiyuan_shop)) foreach($shiyuan_shop AS $renqi): ?>
	...
	<section class="g-main">
	    <div class="m-tt1">
		    <h2 class="fl"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist">百元区</a></h2>
		    <div class="fr u-more">
			    <a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist" class="u-rs-m1"><b class="z-arrow"></b></a>
		    </div>
	    </div>
	    <article class="clearfix h5-1yyg-w310 m-round m-tj-li">
		    <ul id="ulRecommend">
		        <?php $ln=1;if(is_array($baiyuan_shop)) foreach($baiyuan_shop AS $renqi): ?>
			        <li id="<?php echo $renqi['id']; ?>">
			            <div class="f_bor_tr">
			                <div class="m-tj-pic">
			                    <a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $renqi['id']; ?>" class="u-lott-pic">
