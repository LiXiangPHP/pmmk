...
<div id="left">
    ...
    <ul class="left_date" id="setting">   
     ...
     <?php } else{?>
        <ul class="left_date" id="setting">   
         <?php if($info['neirong']){?> <li class="left_date"><a href="#" onClick="secBoard('nav',1,'content','内容管理');">内容管理</a></li><?php } ?>
            <?php if($info['shop']){?> <li class="left_date"><a href="#" onClick="secBoard('nav',2,'shop','商品管理');">商品管理</a></li><?php } ?>
     ...
     <ul class="left_date" id="user">   
        ...
        <li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/inviter">邀请管理</a></li>
